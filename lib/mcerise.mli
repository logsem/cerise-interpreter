...
module Codec :
  sig
    ...
    val to_operand :
      ...
      Instruction_codec.register_or_constant
    val r :
      Ast.register Instruction_codec.shape
    val rr :
      (Ast.register *
       Ast.register)
      Instruction_codec.shape
...
module Machine :
  sig
    ...
    val lower_instruction :
      ...
      (Ast.instruction, Diagnostic.t list)
      result
    val lower_program :
      Runtime_config.t ->
      Ast.statement list ->
    ...
    val value :
      ...
      Ast.reg_or_const ->
      Ast.word
    val is_u : Ast.permission -> bool
    val is_wl : Ast.permission -> bool
    val can_read_upto : Ast.word -> Z.t
    val can_read : Ast.permission -> bool
    val can_write : Ast.permission -> bool
    val executable : Ast.permission -> bool
    val promote :
      Ast.permission ->
      Ast.permission
