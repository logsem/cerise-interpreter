module Ast : sig
  ...
  type instruction =
    ...
    | IsPtr of register * register | GetP of register * register
    | GetL of register * register | GetB of register * register
    | GetE of register * register | GetA of register * register
    | Fail | Halt
...
module Asm_ir : sig
  ...
  type constant_term =
    | Expression of expression | Permission of Ast.permission
    | Permission_locality of permission_term * locality_term
    | Parameterized_permission_locality of string * locality_term
    | Locality_constant of Ast.locality | Value_parameter of string
