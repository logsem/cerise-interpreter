...
let to_string (zi : t) = match zi with Inf -> "∞" | Int z -> Z.to_string z

let add (zi1 : t) (zi2 : t) : t =
  match (zi1, zi2) with Int z1, Int z2 -> Int Z.(z1 + z2) | _, _ -> Inf
...
let sub (zi1 : t) (zi2 : t) : t =
  ...
  | _, Inf ->
      raise
      @@ InfiniteZException (Printf.sprintf "Substraction \"%s - ∞\"  not allowed." (to_string zi1))
...
let eq (zi1 : t) (zi2 : t) : bool =
  match (zi1, zi2) with Int z1, Int z2 -> z1 = z2 | Inf, Inf -> true | _, _ -> false
...
let lt (zi1 : t) (zi2 : t) : bool =
  match (zi1, zi2) with Int z1, Int z2 -> z1 < z2 | Inf, _ -> false | _, Inf -> true
...
let leq (zi1 : t) (zi2 : t) : bool =
  match (zi1, zi2) with Int z1, Int z2 -> z1 <= z2 | _, Inf -> true | Inf, _ -> false
...
let gt (zi1 : t) (zi2 : t) : bool =
  match (zi1, zi2) with Int z1, Int z2 -> z1 > z2 | _, Inf -> false | Inf, _ -> true
...
let geq (zi1 : t) (zi2 : t) : bool =
  match (zi1, zi2) with Int z1, Int z2 -> z1 >= z2 | Inf, _ -> true | _, Inf -> false
