...
module Codec :
  sig
    ...
    val unit_case :
      string -> 'a -> ('a -> bool) -> 'a Instruction_codec.case
    val cases :
      Ast.instruction
    ...
    val permission_scalar : Ast.permission -> int
...
module Machine :
  sig
    ...
    val read_register : RegMap.key -> t -> Ast.word
    val read_memory :
    ...
    val can_store_local : Ast.permission -> bool
    val is_exec : Ast.permission -> bool
    val is_uninitialized : Ast.permission -> bool
    val promote :
      Ast.permission ->
      Ast.permission
    val locality_flows :
      Ast.locality ->
      Ast.locality -> bool
    val readable_limit : Ast.word -> Z.t
    val word_type :
      Ast.word ->
      Ast.word_type
    val bounds : Ast.sealable -> Z.t * Z.t * Z.t
    val locality :
      Ast.sealable ->
      Ast.locality
    val with_cursor :
    ...
    val capability_of_word :
      Ast.word -> (Z.t * Z.t) option
    val overlaps :
      Ast.word ->
      Ast.word -> bool
    val unique_register : t -> RegMap.key -> bool
    val unique_address : t -> MemMap.key -> bool
    val valid_pc : t -> bool
    val write_next : RegMap.key -> Ast.word -> t -> t
    ...
    val read_mem : MemMap.key -> t -> Ast.word option
    val set_reg : RegMap.key -> Ast.word -> t -> t
    val set_mem : MemMap.key -> Ast.word -> t -> t
    val run : t -> t
  end
