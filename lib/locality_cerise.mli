module Ast : sig
  ...
  type instruction =
    ...
    | GetL of register * register | GetB of register * register | GetE of register * register
    | GetA of register * register | GetP of register * register
    | GetOType of register * register | GetWType of register * register
    | Seal of register * register * register | UnSeal of register * register * register
    | Invoke of register * register | Fail | Halt
end
...
module Asm_ir : sig
  ...
  type constant_term =
    ...
    | Locality_constant of Ast.locality | Word_type of Ast.word_type | Value_parameter of string
  ...
  type instruction_term =
    ...
    | GetP_term of register_term * register_term | GetOType_term of register_term * register_term
  ...
  type parameter_kind =
    | Register_kind | Expression_kind | Value_kind | Permission_kind | Seal_permission_kind
