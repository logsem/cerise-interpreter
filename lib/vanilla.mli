module Ast : sig
  ...
  type instruction =
    ...
    | UnSeal of register * register * register | Invoke of register * register | Fail | Halt
end
...
module Asm_ir : sig
  ...
  type instruction_term =
    ...
    | Invoke_term of register_term * register_term | Fail_term | Halt_term
...
module Machine : sig
  ...
  type t = { config : Runtime_config.t; status : status; registers : Ast.word RegMap.t; memory : Ast.word MemMap.t }
