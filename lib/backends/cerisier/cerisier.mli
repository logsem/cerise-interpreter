module Ast : sig
  ...
  type sealable = Cap of permission * Z.t * Z.t * Z.t | SealRange of seal_permission * Z.t * Z.t * Z.t
  type word = I of Z.t | Sealable of sealable | Sealed of Z.t * sealable
  type instruction =
    | Jmp of register | Jnz of register * register | Move of register * reg_or_const
    | Load of register * register | Store of register * reg_or_const
    ...
    | Lt of register * reg_or_const * reg_or_const | Lea of register * reg_or_const
    | Restrict of register * reg_or_const
    | SubSeg of register * reg_or_const * reg_or_const
    | GetB of register * register | GetE of register * register | GetA of register * register
    | GetP of register * register | GetOType of register * register
    | GetWType of register * register | Seal of register * register * register
    | UnSeal of register * register * register | Invoke of register * register
    | Hash of register * register
    | HashConcat of register * reg_or_const * reg_or_const
    | EInit of register * register | EDeInit of register
    | EStoreId of register * register | IsUnique of register * register
    | Fail | Halt
end
...
module Asm_ir : sig
  ...
  type constant_term =
    | Expression of expression | Permission of Ast.permission | Seal_permission of Ast.seal_permission
    | Word_type of Ast.word_type | Value_parameter of string
  ...
  type word_term = I_term of expression | Sealable_term of sealable_term | Sealed_term of expression * sealable_term
  type word = word_term
  type instruction_term =
    ...
    | GetB_term of register_term * register_term | GetE_term of register_term * register_term
    | GetA_term of register_term * register_term | GetP_term of register_term * register_term
    | GetOType_term of register_term * register_term | GetWType_term of register_term * register_term
    ...
    | EInit_term of register_term * register_term | EDeInit_term of register_term
  ...
  type parameter_kind = Register_kind | Expression_kind | Value_kind | Permission_kind | Seal_permission_kind | Word_type_kind
  ...
  val lower_regfile : Runtime_config.t -> regfile -> ((Ast.register * Ast.word) list, Diagnostic.t list) result
end
...
module Printer : sig
  ...
  val instruction : Ast.instruction -> string
end
...
module Machine : sig
  ...
  module ETableMap : Map.S with type key = Z.t
