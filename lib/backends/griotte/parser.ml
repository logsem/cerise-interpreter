(* Turn source text into Griotte assembly terms, preserving lexer and parser source
   locations before the shared assembler expands macros and resolves symbols. *)
