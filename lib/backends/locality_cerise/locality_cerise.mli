(** Public Locality-Cerise backend group. Semantic machine types live in [Ast], unresolved source
    terms in [Asm_ir], and [Backend] is the uniform session-facing adapter. *)
