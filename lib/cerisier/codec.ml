...
let case ~name shape = Instruction_codec.case ~name ~allocation:(Fixed (fixed_opcode name)) shape
...
let locality_scalar = function Directed -> 0 | Local -> 1 | Global -> 2
